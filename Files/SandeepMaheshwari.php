    ...
    <div class="container">
        <div class="text-center">
            <div class="fixed-top" style="margin-top: 80px;">
                <h1 align="center" id="title">Sandeep Maheshwari</h1>
            </div>
            <div class="row" id="col-md-8">
                <div class="col-md-6">
                    <h2 id="div1_right">
                        ...
                        <br>
                        <p style="float:right;"> - Sandeep Maheshwari</p>
                    </h2>
                    <h2 id="div11_right">
                ...
                <div class="col-md-6">
                    <h2 id="div1_right">
                        ...
                        <p style="float:right;"> - संदीप महेश्वरी</p>
                    </h2>
                    <h2 id="div11_right">
                    ...
                    <h2 id="div11_right">
                        " बस इतनी सी बात समझो, ज़िन्दगी एक खेल है।"
                        <br>
                        <p style="float:right;"> - संदीप महेश्वरी</p>
                    </h2>
                </div>
