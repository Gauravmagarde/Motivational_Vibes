    ...
    <div class="container">
        <div class="text-center">
            <div class="fixed-top" style="margin-top: 80px;">
                <h1 align="center" id="title">Quotes On Leadership</h1>
            </div>
            <div class="row" id="col-md-8">
                <div class="col-md-6">
                    <h2 id="div41_left" class="one">
        ...
        <div class="text-center">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <h2 id="div11_left">
                        "Great leaders do not fear challenges, because challenges do not break leaders but sharpen them."
                    </h2>
                    <h2 id="div1_left">
