    ...
    <div class="container">
        <div class="text-center">
            <div class="fixed-top" style="margin-top: 80px;">
                <h1 align="center" id="title">Quotes On Patience</h1>
            </div>
            <div class="row" id="col-md-8">
                <div class="col-md-6">
                    <h2 id="div42_left" class="one">
                        “The two most powerful warriors are patience and time.” </h2>
        ...
        <div class="text-center">
            <div class="row">
                <div class="col-md-6" id="col-md-82">
                    ...
                    <h2 id="div11_left">
                        “Idleness is sweet, and it’s consequences are cruel”
                    </h2>
