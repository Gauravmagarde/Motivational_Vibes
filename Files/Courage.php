    ...
    <div class="container">
        <div class="text-center">
            <div class="fixed-top" style="margin-top: 80px;">
                <h1 align="center" id="title">Quotes On Courage</h1>
            </div>
            <div class="row" id="col-md-8">
                <div class="col-md-6">
                    <h2 id="div3_left" class="one">
        ...
        <div class="text-center">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <h2 id="div22_right">
                        “Courage is resistance to fear, mastery of fear – not the absence of fear. Except a creature be part coward it is not a compliment to say it is brave.”
                    </h2>
                    <h2 id="div21_right">
