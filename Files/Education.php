    ...
    <div class="container">
        <div class="text-center">
            <div class="fixed-top" style="margin-top: 80px;">
                <h1 align="center" id="title">Quotes On Education</h1>
            </div>
            <div class="row" id="col-md-8">
                <div class="col-md-6">
                    <h2 id="div1_right" class="one">
                        "The birthday of my child is the day I because a dad. No other day will ever mean as much to me as this one."
                    </h2>
                    <h2 id="div11_right">
                        "To the WORLD you are a dad. To our FAMILY, you are the world."</h2>
                    <h2 id="div1_right">
                        "Ten toes, ten fingers, two eyes, two lips, and one nose; I can't wait to meet each part of you! As your father, it is your heart I promise to cherish most."
                    </h2>
                    <h2 id="div11_right">
                        "You reserved a place in my heart before yours was even formed."
                    </h2>
                </div>
                <div class="col-md-6">
                    <h2 id="div1_left">
                        "I promise to cherish and protect you before all others in this life. You became my everything before you even arrived!"
                    </h2>
                    <h2 id="div11_left">
                        "From the moment I heard I was going to be a father, I knew my world would never be the same."
                    </h2>
                    <h2 id="div1_left">
                        "The love I feel for my unborn [son or daughter] is no match for any love I've felt before."
                    </h2>
                    <h2 id="div11_left">
