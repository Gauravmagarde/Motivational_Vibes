    ...
    <div class="container">
        <div class="text-center">
            <div class="fixed-top" style="margin-top: 80px;">
                <h1 align="center" id="title">Quotes On Experiance</h1>
            </div>
            <div class="row" id="col-md-8">
                <div class="col-md-6">
                    <h2 id="div22_right" class="one">
                        “The only source of knowledge is experience.”
                    </h2>
                    <h2 id="div21_right">
                        "Humor is one of the cognitive strengths connecting our basic temperament and our lifetime experiences."
                    </h2>
                    <h2 id="div22_right">
                        "But almost all graduates experience both a sense of excitement and perhaps a little nervousness about "what comes next."
                    </h2>
                    <h2 id="div21_right">
